                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="single-product-content">
                            ...
                            <p class="single-product-pricing"><span>Per Kg</span> ${product.p_price}$</p>
                            <p> ${product.desc}</p>  
                            <p><b> production date - expiry date: ${product.date_manufacture} - ${product.date_expriration}</p>  
